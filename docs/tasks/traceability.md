...
| --- | --- | --- |
| RF-01, RF-02 | [013](013-mcp-stdio-server.md), [014](014-installation-and-harnesses.md) | Implemented [real stdio client discovery and tool contract tests](../../test/mcp-server.test.ts); installed harness smoke tests planned |
| RF-03 | [007](007-lm-studio-and-health.md), [013](013-mcp-stdio-server.md) | Implemented health feature tests and [MCP health registration](../../test/mcp-server.test.ts) |
...
| RF-20 | [010](010-repository-exploration.md), [013](013-mcp-stdio-server.md) | Implemented domain progress and [MCP progress notification tests](../../test/mcp-server.test.ts) |
...
| RF-27 | [002](002-core-contracts.md), [013](013-mcp-stdio-server.md) | Implemented type/serialization and [MCP structured-content tests](../../test/mcp-server.test.ts) |
...
| CA-03, CA-04, CA-05 | [007](007-lm-studio-and-health.md), [013](013-mcp-stdio-server.md) | Implemented [health diagnostics](../../test/health.test.ts) and [healthy MCP process coverage](../../test/mcp-server.test.ts) |
| CA-06 | [005](005-repository-path-sandbox.md), [010](010-repository-exploration.md), [013](013-mcp-stdio-server.md) | Implemented feature and [pre-handler MCP empty-goal validation](../../test/mcp-server.test.ts) |
...
| CA-30 | [010](010-repository-exploration.md), [013](013-mcp-stdio-server.md) | Implemented progress source and [supported/unsupported MCP client tests](../../test/mcp-server.test.ts) |
...
| CA-34, CA-35, CA-36, CA-37, CA-38, CA-39 | [004](004-configuration-mutation.md), [008](008-task-lifecycle.md), [013](013-mcp-stdio-server.md) | Implemented mutation/snapshot tests and [MCP validation plus unconfirmed-update coverage](../../test/mcp-server.test.ts) |
| CA-40 | [011](011-test-proposal.md) | Implemented [used-file fingerprint recheck](../../test/test-proposal.test.ts) |
| CA-41, CA-42 | [002](002-core-contracts.md), [010](010-repository-exploration.md), [013](013-mcp-stdio-server.md) | Implemented envelope contracts, localized fields, and [Portuguese MCP serialization](../../test/mcp-server.test.ts) |
